...
-- Cleanup: do NOT access any property on stale Delphi objects —
-- even .Enabled = false triggers C-level access violations on destroyed objects.
-- Just nil all references and let CE GC handle the rest.
_mtDiagWrite("[cleanup] nil-ing stale references (no Delphi access)")
_maLoaderTimer = nil
_maTabTimer = nil
